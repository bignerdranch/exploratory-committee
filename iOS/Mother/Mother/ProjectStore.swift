...
extension Project {
    static func demoProject() -> Project {
        ...
        let sq1 = Screen(uuid: sq1uuid, url: "", name: "", firstScreen: true, hotspots: [
